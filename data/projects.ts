...
export const projects: Project[] = [
  ...
  {
    slug: "anuncios-coterranea",
    title: "Anuncios en video",
    client: "Coterránea",
    year: 2026,
    category: "reel",
    summary: "Video vertical para la pauta permanente de los proyectos de parcelas.",
    description:
      "⚠️ Describir el enfoque: recorridos de terreno, mensaje de los primeros segundos, cuántas variantes se produjeron para testear.",
