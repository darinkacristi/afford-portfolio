...
export const projects: Project[] = [
  {
    ...
    {
    slug: "coterranea-video-anuncio",
    title: "Video anuncio",
    client: "Coterránea",
    year: 2025,
    category: "reel",
    summary: "Pieza vertical para pauta en Meta.",
    description:
      "Video anuncio para la pauta de Coterránea, construido para el primer contacto en frío: la parcela y la propuesta quedan claras en los primeros segundos, antes de que el usuario decida seguir deslizando.",
    scope: ["Guion", "Grabación", "Edición"],
    credits: [{ member: "baithiare", role: "Grabación y edición" }],
    format: "vertical",
    cover: "/work/oyemarco-portada.png",
    video: { kind: "youtube", id: "E1qtK0ENMUA" },
    featured: false,
  },
    {
    ...
    credits: [
      ...
      { member: "baithiare", role: "Grabación y edición" },
    ],
    format: "vertical",
    cover: "/work/guissesketch-portada.png",
    video: { kind: "youtube", id: "OPQPC1hm2Uo" },
    featured: false,
  },
    {
